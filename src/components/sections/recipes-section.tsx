...
const recipes = [
  ...
  { id: 6, name: "Смузи-боул", alt: "вместо молочного коктейля", emoji: "🍓", time: "10 мин", cal: "280 ккал", tags: ["Завтрак", "Антиоксиданты"], color: "from-pink-300/40 to-rose-300/30", ingredients: ["Замороженная клубника", "Банан", "Греческий йогурт", "Мюсли", "Семена чиа", "Мёд"], steps: "Взбить ягоды с йогуртом до густой консистенции. Вылить в боул, украсить топпингами." },
  ...
  return (
    <section className="flex min-h-screen w-screen shrink-0 flex-col justify-center px-6 py-16 md:px-12">
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl">
        <div className="mb-8">
          ...
          <h2 className="font-sans text-4xl font-bold leading-tight text-sky-900 md:text-5xl">
            30 здоровых альтернатив<br />
            <span className="text-green-600">фастфуду</span>
          </h2>
        </div>
      ...
      {selected && (
        ...
        >
          <div
            className={`glass-card max-w-md w-full rounded-3xl border border-white/70 bg-gradient-to-br ${selected.color} p-6 shadow-2xl`}
            onClick={e => e.stopPropagation()}
          >
            <div className="mb-1 text-4xl">{selected.emoji}</div>
